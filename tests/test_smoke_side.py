...
class TestSmoketest():
  ...
  def test_adminPage(self):
    ...
    self.driver.find_element(By.ID, "username").send_keys("vatuxuqen")
  ...
  def test_joinPage(self):
    ...
    assert len(elements) > 0
    self.driver.find_element(By.NAME, "fname").send_keys("Shad Buckner")
    self.driver.find_element(By.NAME, "lname").send_keys("Nero Kim")
    self.driver.find_element(By.NAME, "bizname").send_keys("Avram Hull")
    self.driver.find_element(By.NAME, "biztitle").send_keys("Iste sunt vero offi")
